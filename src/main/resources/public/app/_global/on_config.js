...
function OnConfig($stateProvider, $urlRouterProvider, $httpProvider, $injector, APP_SETTINGS, $translateProvider) {
    $urlRouterProvider.otherwise(function ($injector) {
        var globalService = $injector.get('globalService');
        var state = $injector.get('$state');
        var stateName = "app.entriesList";
        state.go(stateName);
    });
    ...
    $stateProvider
        .state('app.tasksList', {
            ...
            templateUrl: (isNotMobile) ? "views/tasks-list.html" : "views/tasks-list-mobile.html",
            title: 'My Tasks'
